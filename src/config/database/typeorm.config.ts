...
export const AppDataSource: DataSourceOptions = {
  ...
  entities: [
    ...
    ExperienceEntity, CertificateEntity, BlogEntity, CategoryEntity, PostBlockEntity,
    ServiceEntity, ProcessStepEntity, LanguageEntity, HumanResourceTranslationEntity,
    ServiceTranslationEntity, BlogTranslationEntity, CategoryTranslationEntity,
